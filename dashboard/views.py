...
from .models import Slide, Annotation, Activity, Folder
...
def slide(request, slide_id):
    ...
    return render(request, 'slides/slide.html', {'Slide': s, 'Label': request.build_absolute_uri(s.LabelUrlPath), 'back_url': back_url, 'annotations': s.Annotations})
